...
@interface JALayoutDemoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong) NSArray *dataArray;

@end

@implementation JALayoutDemoController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.row) {
        case 0:
            [self.navigationController pushViewController:[[JALayoutTest_UIViewProperty_translatesAutoresizingMaskIntoConstraints alloc] init] animated:YES];
            break;
        case 1:
