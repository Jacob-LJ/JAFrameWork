...
- (void)reload
{
    ...
    self.lastSelectedBtn = self.menuButtons.firstObject;
    self.lastSelectedBtn.selected = YES;
    self.lastSelectedImage = [self.lastSelectedBtn imageForState:UIControlStateSelected];
...
- (void)btnClick:(UIButton *)button
{
    ...
    if (self.lastSelectedBtn == button) {
        if (self.isShowMenu) {
            [button setImage:self.otherSelectedImage forState:UIControlStateSelected];
        } else {
            [button setImage:self.lastSelectedImage forState:UIControlStateSelected];
        }
    } else {
