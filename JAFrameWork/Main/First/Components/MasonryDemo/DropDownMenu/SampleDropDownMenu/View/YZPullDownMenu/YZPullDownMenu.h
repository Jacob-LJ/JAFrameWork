...
@optional
/**
 *  点击下拉菜单按钮响应代理，该方法会覆盖原按钮点击事件方法
 */
- (void)pullDownMenu:(YZPullDownMenu *)pullDownMenu didClickMenuButton:(UIButton *)button otherButtons:(NSArray *)otherBtns;
...
//额外的选中状态的图片
@property (nonatomic, strong) UIImage *otherSelectedImage;
