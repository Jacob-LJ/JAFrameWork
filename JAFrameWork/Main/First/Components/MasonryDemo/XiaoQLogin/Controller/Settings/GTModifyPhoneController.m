...
@interface GTModifyPhoneController ()
...
@implementation GTModifyPhoneController
...
- (void)inputViewDidChangeText {
    ...
    if (self.pwInputV.text.length && self.phoneInputV.text.length && self.securityCodeInputV.text.length) {
...
- (PhoneInputView *)phoneInputV {
    if (!_phoneInputV) {
        ...
        _phoneInputV.leftTile = @"新手机号";
        _phoneInputV.leftImageName = nil;
        _phoneInputV.placeHolder = @"请输入新手机号";
        JAWeakSelf;
