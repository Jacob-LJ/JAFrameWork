//
//  GTSetNewPayPasswordController.m
//  XQCity
//
...
@interface GTSetNewPayPasswordController ()
...
@implementation GTSetNewPayPasswordController
...
- (PasswordInputView *)pwInputV {
    if (!_pwInputV) {
        ...
        _pwInputV.textFieldLeftMargin = 129;
        JAWeakSelf;
...
- (PasswordInputView *)newPwInputV {
    if (!_newPwInputV) {
        ...
        _newPwInputV.leftTile = @"新支付密码";
        _newPwInputV.leftImageName = nil;
        _newPwInputV.placeHolder = @"请输入新密码";
        _newPwInputV.textFieldLeftMargin = 129;
        JAWeakSelf;
...
- (PasswordInputView *)confirmPwInputV {
    if (!_confirmPwInputV) {
        ...
        _confirmPwInputV.leftTile = @"确认新支付密码";
        _confirmPwInputV.leftImageName = nil;
        _confirmPwInputV.placeHolder = @"请重复输入新密码";
        _confirmPwInputV.textFieldLeftMargin = 129;
        JAWeakSelf;
