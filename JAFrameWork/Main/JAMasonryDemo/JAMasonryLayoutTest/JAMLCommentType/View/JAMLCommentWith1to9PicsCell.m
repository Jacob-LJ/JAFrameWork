...
@implementation JAMLCommentWith1to9PicsCell
...
- (void)addConstraintsOnSubviews {
    ...
    //    CGFloat avatarTopMargin = 12;
    //    CGFloat avatarWH = 54;
    //    CGFloat marginLR = 12;
    //    CGFloat imageVNameLBMargin = 12;
    //    CGFloat contentLBTopMargin = 12;
...
//九宫格view
- (JAMLSudokuView *)sudokuView {
    if (!_sudokuView) {
        _sudokuView = [[JAMLSudokuView alloc] init];
