//
//  JAMLCommentWith1to9PicsController.m
//  JAFrameWork
//
...
static NSString * const JAMLCommentWith1to9PicsCellID = @"JAMLCommentWith1to9PicsCell";

@interface JAMLCommentWith1to9PicsController ()<UITableViewDelegate, UITableViewDataSource>//, XLPhotoBrowserDelegate, XLPhotoBrowserDatasource>
...
@implementation JAMLCommentWith1to9PicsController
...
- (void)setUpTableView {
    ...
    [self.tableView registerClass:[JAMLCommentWith1to9PicsCell class] forCellReuseIdentifier:JAMLCommentWith1to9PicsCellID];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    JAMLCommentWith1to9PicsCell *cell = [tableView dequeueReusableCellWithIdentifier:JAMLCommentWith1to9PicsCellID forIndexPath:indexPath];
    JAWeakSelf;
